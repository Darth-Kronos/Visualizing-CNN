...
class lenet5Conv(nn.Module):
    ...
    def forward(self, x):
        ...
        ReLU = self.first_ReLU(self.output_first_conv2d)
        self.output_first_maxPool2d, self.output_first_maxPool2d_loc = self.first_maxPool2d(ReLU)
        # Block 2
        self.output_second_conv2d = self.second_conv2d(self.output_first_maxPool2d)
        ReLU = self.second_ReLU(self.output_second_conv2d)
        self.output_second_maxPool2d, self.output_second_maxPool2d_loc = self.second_maxPool2d(ReLU)
        # Classifier
